...
export default function Home() {
  return (
    <div className='container'>
      ...
      <main>
        <h1 className='title'>Welcome to our group website!</h1>

        <p className='description'>
          Created by Andy Greer, Andy Gusty, and George Frommell
        </p>
        <code>src/page/teamMemberName.js</code>

        <div className='grid'>
          <a href='/andyGreer' className='card'>
            <h3>About Andy Greer</h3>
            <p>Click here to navigate to Andy Greer's page</p>
          </a>
          <a href='/andrewGusty' className='card'>
